...
public class RandomSpawnObstacles : MonoBehaviour
{
    ...
    void DebugDrawSpawnRange()
    {
        ...
        bottomRightCorner = new Vector3(transform.TransformPoint(0.0f, 0.0f, 0.0f).x + (-spawnRange.x),
              transform.TransformPoint(0.0f, 0.0f, 0.0f).y + (-spawnRange.y),
              transform.TransformPoint(0.0f, 0.0f, 0.0f).z + (-spawnRange.z));

        upperRightCorner = new Vector3(transform.TransformPoint(0.0f, 0.0f, 0.0f).x + (-spawnRange.x),
            transform.TransformPoint(0.0f, 0.0f, 0.0f).y + (spawnRange.y),
            transform.TransformPoint(0.0f, 0.0f, 0.0f).z + (-spawnRange.z));

        upperLeftCorner = new Vector3(transform.TransformPoint(0.0f, 0.0f, 0.0f).x + (spawnRange.x),
           transform.TransformPoint(0.0f, 0.0f, 0.0f).y + (spawnRange.y),
           transform.TransformPoint(0.0f, 0.0f, 0.0f).z + (-spawnRange.z));

        bottomLeftCorner = new Vector3(transform.TransformPoint(0.0f, 0.0f, 0.0f).x + (spawnRange.x),
              transform.TransformPoint(0.0f, 0.0f, 0.0f).y + (-spawnRange.y),
              transform.TransformPoint(0.0f, 0.0f, 0.0f).z + (-spawnRange.z));
